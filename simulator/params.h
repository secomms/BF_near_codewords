...
// Generic Options
// ======================================================================
#define NUM_THREADS        8      ///< Number of threads used for simulation.
...
#define ERROR_WEIGHT 11 ///< Specific error weight for single-weight simulations.

#define U_MIN   3    ///< Minimum value of parameter U (if applicable).
#define U_MAX   11   ///< Maximum value of parameter U.
